...
The Sandbox SDK uses a Ubuntu-based Linux container with common development tools pre-installed:
...
The Sandbox SDK provides three Docker image variants optimized for different use cases:
...
**Use when:** You need Node.js/JavaScript execution but do not require Python capabilities.
...
**What's included:**
- Everything from the default variant
- Python 3.11.14 with pip and venv
- Pre-installed Python packages: matplotlib, numpy, pandas, ipython

**Use when:** You need Python execution, data analysis, or the Code Interpreter API.

### OpenCode

```dockerfile
FROM docker.io/cloudflare/sandbox:0.6.0-opencode
```

**What's included:**
- Everything from the default variant
- [OpenCode](https://opencode.ai/) CLI and web server
- Port 4096 exposed for OpenCode web UI

**Use when:** You want to run OpenCode (AI coding agent) inside Sandbox containers.

**Related:** [OpenCode integration guide](/sandbox/guides/opencode-integration/)
